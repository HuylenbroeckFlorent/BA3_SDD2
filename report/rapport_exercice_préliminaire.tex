...
\textbf{Sorties} :& &Boléen, vrai si le segment appartient à la scène, faux sinon.\\
\textbf{Effets} :& &/
\end{tabular}
\begin{algorithmic}[1]
...
&$B$ :&Point, deuxième extrémité du segment, de coordonnées ($B.x$,$B.y$).\\
...
\textbf{Sorties} :& &Boléen, vrai si le segment [PB] appartient à l'arbre BSP.\\
\textbf{Effets} :& &/
\end{tabular}
\begin{algorithmic}[1]
